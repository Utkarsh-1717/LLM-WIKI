...
source_count: 2
aliases: [wiki-tool, maintenance-gate, wiki_tool]
---

# Wiki Tooling

Deterministic maintenance tooling for the [[llm-wiki]] system. All scripts use Python standard library only. Run before every commit.
...
## Maintenance Gate (Full Order)

Run in this exact order before every commit:
...
- [[quant-agent-system]] — uses these tools for quant workflow maintenance
- [[raw-vs-wiki]] — these tools enforce the two-layer separation
- [[multi-format-ingest]] — `attachment-scan` is part of this tooling
